...
| Flow | CIC, Q-pulsmeter, HP1, HP2, Duo-aggregate of synthesized zero | Q-pulsen en HP R2138 hebben een lokale receipt | Een Duo-aggregate is alleen bruikbaar als de actuele geselecteerde waarde uit het gemiddelde of maximum van twee verse raw receipts volgt; synthesized zero is verboden |
