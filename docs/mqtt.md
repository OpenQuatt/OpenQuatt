...
De [keuze voor gebruiksstatistieken](web-app.md#gebruiksstatistieken-en-privacy) gebruikt een aparte outbound-only MQTT-client om de centrale OpenQuatt-loggingserver te bereiken. De huidige standaardconfiguratie gebruikt poort 1883 zonder TLS. Die client deelt geen entiteiten, discovery-berichten of reguliere logs en gebruikt niet de brokerconfiguratie van deze MQTT inputbronnen. Het uurbericht vermeldt alleen of MQTT inputbronnen als geheel aanstaan. Na een echte firmwarecrash kan daarnaast beperkte ruwe crashinformatie worden gepubliceerd; de broker bewaart alleen de laatste crash retained totdat een volgende crash of opt-out deze vervangt respectievelijk wist. Brokergegevens, wifi-netwerknaam, wifi-wachtwoord, gebruikersnamen, andere wachtwoorden, topics en ontvangen waarden worden nooit meegestuurd. Zoals bij iedere internetverbinding is het bron-IP-adres technisch zichtbaar voor de loggingserver; OpenQuatt slaat dit IP-adres niet op.
