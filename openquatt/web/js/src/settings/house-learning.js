...
const REASON_LABELS = {
  ...
  calorimetry_not_verified: "warmtemeting nog niet gecontroleerd",
  external_heat_not_excluded: "ketelbijdrage nog niet uitgesloten",
  unmodeled_gain_bound_unknown: "zon en interne warmte nog niet beoordeeld",
  ...
  unmodeled_gains: "warmte onvoldoende begrensd",
