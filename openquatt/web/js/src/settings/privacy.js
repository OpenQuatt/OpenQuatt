...
export function renderSettingsPrivacySection() {
  ...
  return renderSettingsSection(
    ...
    "Hier kies je of OpenQuatt beperkte technische gebruiksstatistieken en na een echte firmwarecrash het laatste technische crashrapport deelt. Wifi-netwerknaam, wifi-wachtwoord en andere wachtwoorden of inloggegevens worden nooit meegestuurd. Een niet-bevestigde keuze blijft uit.",
