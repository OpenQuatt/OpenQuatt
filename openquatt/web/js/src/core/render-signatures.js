...
export function getOverviewControlsRenderSignature() {
  return [
    ...
    getEntitySignatureFragment("coolingMinimumOffTimeRemaining"),
    getEntitySignatureFragment("hp1MinimumOffRemaining"),
    getEntitySignatureFragment("hp2MinimumOffRemaining"),
    getEntitySignatureFragment("coolingStopConfirmationPending"),
    getEntitySignatureFragment("requestReason"),
    getEntitySignatureFragment("coolingRequestHp1Level"),
    getEntitySignatureFragment("coolingRequestHp2Level"),
    getEntitySignatureFragment("coolingRequestOwnerHp"),
