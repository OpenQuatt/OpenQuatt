...
import { fetchWithTimeout } from "./browser-utils.js";
  ...
  export const SETTINGS_GROUP_KEY_MAP = {
    installation: [
      ...
      "maxWater",
      ...ODU_RUNTIME_FREQUENCY_INITIAL_KEYS,
    ],
    service: [
